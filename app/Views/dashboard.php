  ...
  <div class="col-6 col-md-3">
    <div class="card border-0 shadow-sm h-100 bg-light">
      <div class="card-body">
        <div class="d-flex align-items-center gap-2 mb-2">
          <span class="fs-4">📋</span>
          <div class="text-muted small text-uppercase fw-semibold">Lecturas pendientes</div>
        </div>
        <div class="fs-6 fw-semibold text-muted">Próximamente</div>
      </div>
    </div>
  </div>
</div>
...
<div class="card border-0 shadow-sm">
  <div class="card-body">
    <h2 class="h6 fw-bold text-primary mb-2">Bienvenido a SIGA</h2>
